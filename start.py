...
def doStart():
    ...
    nms_server_add_container="docker run --name nms_server -d -p 8888:8888 -v /Framework:/Framework nms_server:v1"
    ...
    nms_gateway_add_container = "docker run --name nms_gateway  -p 9999:9999 -d -v /Framework:/Framework nms_gateway:v1 --spring.datasource.url=jdbc:mysql://"+mysql_IPAddress_value+"/test --spring.cloud.client.ipAddress="+nms_server_IPAddress_value
    ...
    nms_adaptor_add_container = "docker run --name nms_adaptor  -p 6666:6666 -d -v /Framework:/Framework nms_adaptor:v1 --spring.datasource.url=jdbc:mysql://"+mysql_IPAddress_value+"/test --spring.cloud.client.ipAddress="+nms_server_IPAddress_value
    ...
    nms_mts_add_container = "docker run --name nms_mts -p 7777:7777  -d -v /Framework:/Framework nms_mts:v1 --spring.datasource.url=jdbc:mysql://"+mysql_IPAddress_value+"/test --spring.cloud.client.ipAddress="+nms_server_IPAddress_value
